...
import { getProfile, getUserStats, updateProfile, updateNotificationToken } from '../controllers/user.controller.js';
...
router.post('/notification-token', protectRoute, updateNotificationToken);
